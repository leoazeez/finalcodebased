...
$conn = mysqli_connect("localhost:3306","root","") or die("Error: Connection Issue");
$bd = mysqli_select_db($conn,"plagiarism_tester") or die("Error: Database Issue");
    ...
    <figure id="ctdetails">
      <ul class="nospace group">
        <li class="one_quarter first">
          <div class="clear"><a href="questions_list.php"><i class="fas fa-question"></i></a> <span><strong>Questions</strong>Return to Questions</span></div>
        </li>

...
<?php
		...
		if (!empty($_POST["register"])) {
			...
			$chk_email = "select * from convenor where email='$email'";
			...
			if($l = mysqli_fetch_row($get_email)){
				...
				$create_sql = "INSERT INTO `convenor` (`convenor_id`, `name`,`email`,`password`) VALUES ('$convenorId', '$name', '$email', '$password')";
...
<body id="top">
  ...
  <div class="background-color">
		...
		<div class="login-form">
			<form method="post" action="convenor_createAccount.php" novalidate="novalidate">
				<h1 class="login-label">Create convenor Account</h1>
				<div class="content">
					<div class="input-field">
						<input type="email" placeholder="Email" name ="email" autocomplete="nope">
					</div>
					<div class="input-field">
						<input type="text" placeholder="Staff ID" name = "id" autocomplete="nope">
					</div>
					<div class="input-field">
